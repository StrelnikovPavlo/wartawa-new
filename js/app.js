(() => {
   ...
   (() => {
      ...
      function rangeInit() {
         const slidersRange = document.querySelectorAll("._line-range");
         for (let index = 0; index < slidersRange.length; index++) {
            const sliderRange = slidersRange[index];
            const rangeSlider = sliderRange.querySelector(".range-slider");
            ...
            let valueBlock = sliderRange.querySelector(".input-range");
            rangeSlider.noUiSlider.on("update", (function (values) {
               valueBlock.innerHTML = Math.round(values);
            }));
         }
      }
      rangeInit();
      ...
      window.onload = function () {
         ...
         function documentActions(e) {
            ...
            const detailsCrypt = document.querySelectorAll(".details-crypt");
            const conclusionCrypt = document.querySelectorAll(".details-conclusion");
            const replenishmentCrypt = document.querySelectorAll(".details-replenishment");
            const allDetailsCrypt = document.querySelectorAll(".details-home");
            if (targetElement.classList.contains("user-header__name-item")) userMenu.classList.toggle("_hover");
            if (targetElement.classList.contains("user-header__name")) userMenu.classList.toggle("_hover");
            if (targetElement.classList.contains("menu-sidebar__item-profil")) userMenu.classList.toggle("_hover");
            if (window.innerWidth > 768) {
               if (targetElement.classList.contains("info-investment__close")) {
                  let allDate = document.querySelectorAll(".close-action");
                  allDate.forEach((dateAll => {
                     dateAll.classList.remove("_active");
                  }));
               }
               let tabs = document.querySelectorAll("._data-tabs");
               if (tabs) for (let index = 0; index < tabs.length; index++) {
                  let tab = tabs[index];
                  let tabs_items = tab.querySelectorAll("._data-tabs-item");
                  let tabs_blocks = tab.querySelectorAll("._data-tabs-block");
            ...
            if (window.innerWidth < 768) {
               if (targetElement.classList.contains("investment-details")) {
                  _slideToggle(investMobile);
                  _slideToggle(investHead);
               }
               if (targetElement.classList.contains("spoller-home__button-details")) detailsCrypt.forEach((cryptDetails => {
                  cryptDetails.classList.add("_active");
                  bodyLockToggle();
               }));
               if (targetElement.classList.contains("spoller-home__button-replenishment")) conclusionCrypt.forEach((cryptСonclusion => {
                  cryptСonclusion.classList.add("_active");
                  bodyLockToggle();
               }));
               if (targetElement.classList.contains("spoller-home__button-conclusion")) replenishmentCrypt.forEach((cryptReplenishment => {
                  cryptReplenishment.classList.add("_active");
                  bodyLockToggle();
               }));
               if (targetElement.classList.contains("details-home__bg")) allDetailsCrypt.forEach((cryptDetailsAll => {
                  bodyUnlock();
                  cryptDetailsAll.classList.remove("_active");
               }));
               if (targetElement.classList.contains("menu-wallets__bg")) {
                  let walletsMenu = document.querySelectorAll(".menu-wallets");
                  walletsMenu.forEach((menuWallets => {
                     menuWallets.classList.remove("_open");
                     bodyUnlock();
                  }));
               }
               //if (targetElement.classList.contains("menu-sidebar__item-profil")) console.log('wkfgnerjfqj');
            }
         }
      };
      if (window.innerWidth < 768) {
         let cardsBank = document.querySelectorAll("._spollersCard");
         for (let index = 0; index < cardsBank.length; index++) {
            const cardBank = cardsBank[index];
            let buttonMore = cardBank.querySelector(".mobile-cart__button-grey");
            let cartInfo = cardBank.querySelector(".cart-replenishment__block");
            let mobileInfo = cardBank.querySelector(".mobile-cart__content");
            let textMore = cardBank.querySelector(".mobile-cart__more");
            let textHide = cardBank.querySelector(".mobile-cart__hide");
            _slideUp(cartInfo);
            _slideDown(mobileInfo);
            buttonMore.addEventListener("click", (function () {
               _slideToggle(cartInfo);
               _slideToggle(mobileInfo);
               textMore.classList.toggle("_hide");
               textHide.classList.toggle("_show");
            }));
         }
         let investmentBlocks = document.querySelectorAll("._investBlocks");
         for (let index = 0; index < investmentBlocks.length; index++) {
            let investmentBlock = investmentBlocks[index];
            let investment = investmentBlock.querySelector(".investment-page__inner-mobile");
            let btnMore = investmentBlock.querySelector(".row-investment__more");
            let investmentHeader = investmentBlock.querySelector(".heading-investment");
            let spanMore = investmentBlock.querySelector(".button-more");
            let spanHIde = investmentBlock.querySelector(".button-hide");
            _slideUp(investment);
            _slideDown(investmentHeader);
            btnMore.addEventListener("click", (function () {
               _slideToggle(investment);
               _slideToggle(investmentHeader);
               spanMore.classList.toggle("_hide");
               spanHIde.classList.toggle("_show");
            }));
         }
         let investmentBlocks2 = document.querySelectorAll("._investBlocks2");
         for (let index = 0; index < investmentBlocks2.length; index++) {
            let investmentBlock2 = investmentBlocks2[index];
            let investment = investmentBlock2.querySelector(".investment-page__inner-mobile");
            let btnMore = investmentBlock2.querySelector(".investment-detl");
            let btnMore2 = investmentBlock2.querySelector(".investment-detl-2");
            let investmentHeader = investmentBlock2.querySelector(".heading-investment");
            let conclusionBtn = investmentBlock2.querySelector(".row-investment__column-mobile");
            let closeBtn = investmentBlock2.querySelector(".row-investment__button-close");
            _slideUp(investment);
            _slideDown(investmentHeader);
            btnMore.addEventListener("click", (function () {
               _slideToggle(investment);
               _slideToggle(investmentHeader);
               conclusionBtn.classList.toggle("_show");
               closeBtn.classList.toggle("_show");
               btnMore.classList.toggle("_hide");
               btnMore2.classList.toggle("_show");
            }));
            closeBtn.addEventListener("click", (function () {
               _slideUp(investment);
               _slideDown(investmentHeader);
               conclusionBtn.classList.remove("_show");
               closeBtn.classList.remove("_show");
               btnMore.classList.remove("_hide");
               btnMore2.classList.remove("_show");
            }));
         }
         let replenishmentCarts = document.querySelectorAll("._spollerDate");
         for (let index = 0; index < replenishmentCarts.length; index++) {
            const replenishmentCart = replenishmentCarts[index];
            let replenishmentHeader = replenishmentCart.querySelector(".cart-replenishment__header");
            let replenishmentBody = replenishmentCart.querySelector(".cart-replenishment__block");
            let replenishmentButton = replenishmentCart.querySelector(".cart-replenishment__hide");
            _slideUp(replenishmentBody);
            replenishmentHeader.addEventListener("click", (function () {
               _slideToggle(replenishmentBody);
            }));
            replenishmentButton.addEventListener("click", (function () {
               _slideUp(replenishmentBody);
            }));
         }
         let mobileWalletsBg = document.querySelector(".mobile-wallets__bg_1");
         if (mobileWalletsBg) mobileWalletsBg.addEventListener("click", (function () {
            let walletsMenu1 = document.querySelector(".menu-wallets-1");
            walletsMenu1.classList.add("_open");
            bodyLockToggle();
            let itemsMenu = document.querySelectorAll(".menu-wallets__item");
            let walletsImg = document.querySelector(".mobile-wallets__methods-img");
            let walletsText = document.querySelector(".mobile-wallets__methods-text");
            for (let index = 0; index < itemsMenu.length; index++) {
               const itemMenu = itemsMenu[index];
               let btnItemImg = itemMenu.querySelector(".menu-wallets__item-img");
               let btnItemText = itemMenu.querySelector(".menu-wallets__item-text");
               itemMenu.addEventListener("click", (function () {
                  bodyUnlock();
                  walletsImg.src = btnItemImg.src;
                  walletsText.innerHTML = btnItemText.innerHTML;
                  walletsMenu1.classList.remove("_open");
               }));
            }
         }));
         let mobileWalletsBg2 = document.querySelector(".mobile-wallets__bg_2");
         if (mobileWalletsBg2) mobileWalletsBg2.addEventListener("click", (function () {
            let walletsMenu2 = document.querySelector(".menu-wallets-2");
            walletsMenu2.classList.add("_open");
            bodyLockToggle();
            let itemsMenu = document.querySelectorAll(".menu-wallets__item-2");
            let walletsImg2 = document.querySelector(".mobile-wallets__methods-img-2");
            let walletsText2 = document.querySelector(".mobile-wallets__methods-text-2");
            for (let index = 0; index < itemsMenu.length; index++) {
               const itemMenu = itemsMenu[index];
               let btnItemImg2 = itemMenu.querySelector(".menu-wallets__item-img-2");
               let btnItemText = itemMenu.querySelector(".menu-wallets__item-text-2");
               itemMenu.addEventListener("click", (function () {
                  bodyUnlock();
                  walletsImg2.src = btnItemImg2.src;
                  walletsText2.innerHTML = btnItemText.innerHTML;
                  walletsMenu2.classList.remove("_open");
               }));
            }
         }));
      }
      const inputPass = document.querySelectorAll(".input__password");
      const showBtn = document.querySelectorAll(".show-password");
      showBtn.forEach((btnShow => {
         btnShow.onclick = () => {
            inputPass.forEach((passInput => {
               if ("password" === passInput.type) {
                  passInput.type = "text";
      ...
      let tabsWallets = document.querySelectorAll("._tabs_wallet");
      for (let index = 0; index < tabsWallets.length; index++) {
         let tab = tabsWallets[index];
         let tabs_items = tab.querySelectorAll("._tabs-item");
         let wallets_input = document.querySelector(".input-wallets");
         for (let index = 0; index < tabs_items.length; index++) {
            let tabs_item = tabs_items[index];
            let tabs_value = tabs_item.querySelector(".wallets-page__value");
            tabs_item.addEventListener("click", (function (e) {
               for (let index = 0; index < tabs_items.length; index++) {
                  let tabs_item = tabs_items[index];
                  tabs_item.classList.remove("_active");
               }
               wallets_input.value = tabs_value.innerHTML;
               console.log(wallets_input.value);
               tabs_item.classList.add("_active");
               e.preventDefault();
            }));
         }
      }
      let tabsPayments = document.querySelectorAll("._tabs_payment");
      for (let index = 0; index < tabsPayments.length; index++) {
         let tabsPayment = tabsPayments[index];
         let tabs_items = tabsPayment.querySelectorAll("._tabs-item");
         let wallets_input = document.querySelector(".input-payment");
         for (let index = 0; index < tabs_items.length; index++) {
            let tabs_item = tabs_items[index];
            let tabs_value = tabs_item.querySelector(".wallets-page__value");
            tabs_item.addEventListener("click", (function (e) {
      ...
      let script_tabs = document.querySelectorAll("._tabs");
      for (let index = 0; index < script_tabs.length; index++) {
         let tab = script_tabs[index];
         let tabs_items = tab.querySelectorAll("._tabs-item");
         for (let index = 0; index < tabs_items.length; index++) {
            let tabs_item = tabs_items[index];
            tabs_item.addEventListener("click", (function (e) {
      ...
      const itemPopup = document.querySelectorAll(".item-popup");
      itemPopup.forEach((popupItem => {
         popupItem.addEventListener("click", (function () {
            popupItem.classList.toggle("_chek");
         }));
      }));
      var headerHomeMenu = document.querySelectorAll(".header-home__menu");
      headerHomeMenu.forEach((menuHomeHeader => {
         menuHomeHeader.addEventListener("click", (function () {
            let userMenu = document.querySelector(".user-header__menu");
            userMenu.classList.toggle("_hover");
         }));
      }));
      const itemSelect = document.querySelectorAll(".add-spoller__row");
      if (itemSelect) itemSelect.forEach((selectItem => {
         selectItem.addEventListener("click", (function () {
            selectItem.classList.toggle("_active");
         }));
      }));
      let selectCarts = document.querySelectorAll("._selectCart");
      for (let index = 0; index < selectCarts.length; index++) {
         let selectCart = selectCarts[index];
         let tabs_items = selectCart.querySelectorAll("._select-wallet");
         let wallets_input = document.querySelector(".input-wallets");
         for (let index = 0; index < tabs_items.length; index++) {
            let tabs_item = tabs_items[index];
            let tabs_value = tabs_item.querySelector(".wallets-page__value");
      ...
      let selectPayments = document.querySelectorAll("._selectPayment");
      for (let index = 0; index < selectPayments.length; index++) {
         let selectPayment = selectPayments[index];
         let tabs_items = selectPayment.querySelectorAll("._select-payment");
         let wallets_input = document.querySelector(".input-payment");
         for (let index = 0; index < tabs_items.length; index++) {
            let tabs_item = tabs_items[index];
            let tabs_value = tabs_item.querySelector(".payment-page__value");
            tabs_item.addEventListener("click", (function (e) {
               for (let index = 0; index < tabs_items.length; index++) {
                  let tabs_item = tabs_items[index];
                  tabs_item.classList.remove("_active");
      ...
      let button_change = document.querySelector(".form-conversion__change");
      if (button_change) button_change.addEventListener("click", (function () {
         let select_chande_1 = document.querySelector(".select_change_1");
         let select_chande_2 = document.querySelector(".select_change_2");
         let select_chande_3 = document.querySelector(".select_change_3");
         let select_chande_4 = document.querySelector(".select_change_4");
         button_change.classList.toggle("rotate");
         select_chande_1.classList.toggle("change_1");
         select_chande_2.classList.toggle("change_2");
         select_chande_3.classList.toggle("change_3");
         select_chande_4.classList.toggle("change_4");
      }));

      document.querySelector('.menu-sidebar__item-profil').addEventListener('click', function () {
         console.log('fejvfwenqnkfjen');
      })


      let repl_Values = document.querySelectorAll("._repls");
      for (let index = 0; index < repl_Values.length; index++) {
         let tab = repl_Values[index];
         let tabs_items = tab.querySelectorAll("._repls-item");
         for (let index = 0; index < tabs_items.length; index++) {
            let tabs_item = tabs_items[index];
            tabs_item.addEventListener("click", (function (e) {
               for (let index = 0; index < tabs_items.length; index++) {
      ...
      // Получаем элементы выбора способа пополнения
const selectItems = document.querySelectorAll('.select-repl__item');

// Получаем блоки информации для каждого способа пополнения
const swiftBlock = document.querySelector('._select-swift-body');
const cartBlock = document.querySelector('._select-cart-body');
const cryptoBlock = document.querySelector('._select-crypto-body');

// Обработчик события для выбора способа пополнения
function handleSelect(event) {
  ...
  swiftBlock.style.display = 'none';
  cartBlock.style.display = 'none';
  cryptoBlock.style.display = 'none';

  // Определяем выбранный способ пополнения
  const selectedMethod = event.currentTarget;

  // Добавляем класс _active выбранному элементу
  selectedMethod.classList.add('_active');

  // Отображаем блок информации для выбранного способа пополнения
  if (selectedMethod.classList.contains('_select-swift')) {
    swiftBlock.style.display = 'block';
  } else if (selectedMethod.classList.contains('_select-cart')) {
    cartBlock.style.display = 'block';
  } else if (selectedMethod.classList.contains('_select-crypto')) {
...
// Отображаем блок информации для первого способа пополнения (_select-swift-body)
swiftBlock.style.display = 'block';

// Находим элемент с классом _select-swift и добавляем ему класс _active
const selectSwiftItem = document.querySelector('.select-repl__item._select-swift');
selectSwiftItem.classList.add('_active');

// Добавляем обработчик события для каждого элемента выбора способа пополнения
selectItems.forEach((item) => {
