   ...
   (() => {
      ...
      window.onload = function () {
         ...
         function documentActions(e) {
            ...
            const userMenuAny = document.querySelector(".user-header__menu");
            ...
            if (targetElement.classList.contains("menu-sidebar__item-profil") || targetElement.classList.contains("menu-sidebar__item-value")) {
               userMenuAny.classList.toggle("_hover");
               document.documentElement.classList.remove("menu-open");
               bodyUnlock();
            }
            if (targetElement.classList.contains("menu-user__close")) {
               userMenuAny.classList.remove("_hover");
            }
